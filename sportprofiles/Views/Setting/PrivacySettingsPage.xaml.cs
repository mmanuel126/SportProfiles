...
public partial class PrivacySettingsPage : ContentPage
{
    ...
    async void SaveProfileSettingsButton_Clicked(System.Object sender, System.EventArgs e)
    {
        try
        {
            ...
            if (ContactsDDL.SelectedIndex != -1)
                psm.ContactInfo = ContactsDDL.SelectedIndex.ToString();
            else
                psm.ContactInfo = "0";
    ...
    async void SavePrivacySearchButton_Clicked(System.Object sender, System.EventArgs e)
    {
        try
        {
            ...
            psm.ViewFriendsList = ContactsList.IsToggled;
    ...
    async void OnRefreshSettings_Clicked(object sender, EventArgs e)
    {
        try
        {
            ...
            await x.GetPrivacySettingsInfo();
